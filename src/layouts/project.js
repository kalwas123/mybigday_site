...
const ProjectTemplate = ({ data }) => {
  ...
  return (
    <>
      <SEO
        title={data.strapiWedding.SEO_Title}
        description={data.strapiWedding.SEO_Description}
        image={data.strapiWedding.SEO_Img.publicURL}
      />
      <MainNav />
      <HeaderImg fluid={data.strapiWedding.Thumbnail.childImageSharp.fluid} />
      <MainWrap>
        <Header>
          <MainInfo>
          ...
          <Description>
            <ReactMarkdown
              ...
              source={data.strapiWedding.Description}
            />
          </Description>
        </Header>
      </MainWrap>
